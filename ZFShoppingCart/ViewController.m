...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([tableView isEqual:self.tableView]) {
        ...
        if (!cell) {
            ...
            cell.plusBlock = ^(NSInteger nCount,BOOL animated)
            {
                ...
                [self storeOrders:dict isAdded:animated withSectionIndex:0 withRowIndex:0 withStateTable:0];
    ...
    else if ([tableView isEqual:_ShopCartView.OrderList.tableView])
    {
        ...
        cell.operationBlock = ^(NSUInteger nCount,BOOL plus)
        {
            ...
            [self storeOrders:dict isAdded:plus withSectionIndex:indexPath.section withRowIndex:indexPath.row withStateTable:1];
...
-(void)storeOrders:(NSMutableDictionary *)dictionary isAdded:(BOOL)added withSectionIndex:(NSInteger)sectionID withRowIndex:(NSInteger)rowID withStateTable:(NSInteger)TBid
{
